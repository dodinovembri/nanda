<?php  
	...
	$id_product = $_GET['id_product_keluar'];
	$q = mysqli_query($koneksi, "UPDATE product_keluar SET status='S' WHERE id_product_keluar='$id_product'");
	$q2 = mysqli_query($koneksi, "UPDATE sub_product_keluar SET status='SC' WHERE id_trx_product_keluar='$id_product'");
...
// 	}
	...
	echo "<script>window.location.href='?module=bahan_baku_keluar'</script>";
?>