<?php  
	...
	$id_trx_product_keluar = $_GET['id_trx_product_keluar'];
	

	// echo $id_product_keluar;
	$q = mysqli_query($koneksi, "SELECT * FROM sub_product_keluar WHERE id_trx_product_keluar='$id_trx_product_keluar' AND status='B'");
	...
	while ($r_s = mysqli_fetch_array($q_s)) {
			$email = $r_s['email'];
		}

	$q2 = mysqli_query($koneksi, "SELECT * FROM sub_product_keluar WHERE id_product_keluar='$id_product_keluar' AND email='$id_supplier' AND status='B'");
...
<br><br><br><br>
 		<div class=main-white style="background-color: #e5e5e5;">
			<div class=container> 
          		<div class=row> 
          		<?php echo $id_trx_product_keluar; ?>
								...
								<div class="container-contact100" style="background: transparent;">
									<div class="wrap-contact100">
										...
										<form class="contact100-form validate-form" method="post" action="?module=kirim_email">
										    ...
										    <input type="hidden" name="id_trx_product_keluar" value="<?php echo $id_trx_product_keluar; ?>">
